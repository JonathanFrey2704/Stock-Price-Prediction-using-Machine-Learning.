# -*- coding: utf-8 -*-
"""
Created on Sun Dec  6 15:05:14 2020

@author: Ihsaan
A univariate TCN needs data in the shape (samples, 1, time_steps)
...
def univariate_preprocessing(num_features,time_steps, df, num_predictions, sampling_method):
    '''
    Ex:
    num_predictions = 2
    ...
    #print(temp)
    temp = temp[2:,:].astype('float32').reshape(-1,num_features,time_steps)
    #print(temp)
